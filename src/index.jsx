...
function Term({term, setTerm}) {
	...
	return (
		<div className="pure-form">
			...
			<fieldset>
				<img src="/public/sor.png" height="40" width="40" alt="Sub-orbital rocket" className="align-middle"/>
			...
			<fieldset>
				<img src="/public/bfr.png" height="40" width="40" alt="BFR" className="align-middle"/>
			...
			<fieldset>
				<img src="/public/jumbo.png" height="40" width="40" alt="Jumbo jet" className="align-middle"/>
			...
			<fieldset>
				<img src="/public/lux.png" height="40" width="40" alt="Luxury jet" className="align-middle"/>
			...
			<fieldset>
				<img src="/public/sep.png" height="40" width="40" alt="Single Engine Plane" className="align-middle"/>
			...
			<fieldset>
				<img src="/public/sat.png" height="40" width="40" alt="Satellite" className="align-middle"/>
...
function Contract({contract, setContract}) {
	...
	return (
		<div className="pure-form">
			<fieldset>
				{ contract.product == 'sep' ? <img src="/public/sep.png" height="40" width="40" alt="Single Engine Plane" className="align-middle"/> : undefined }
				{ contract.product == 'sat' ? <img src="/public/sat.png" height="40" width="40" alt="Satellite" className="align-middle"/> : undefined }
				{ contract.product == 'lux' ? <img src="/public/lux.png" height="40" width="40" alt="Luxury jet" className="align-middle"/> : undefined }
				{ contract.product == 'jumbo' ? <img src="/public/jumbo.png" height="40" width="40" alt="Jumbo jet" className="align-middle"/> : undefined }
				{ contract.product == 'bfr' ? <img src="/public/bfr.png" height="40" width="40" alt="BFR" className="align-middle"/> : undefined }
				{ contract.product == 'sor' ? <img src="/public/sor.png" height="40" width="40" alt="Sub-orbital rocket" className="align-middle"/> : undefined }
